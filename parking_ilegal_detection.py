"""
Sistem Deteksi Parkir Ilegal dengan Zoning
- Deteksi mobil yang masuk zona parkir ilegal
- Hitung durasi parkir ilegal
- Normalisasi koordinat untuk semua resolusi video
"""
import cv2
import numpy as np
import json
